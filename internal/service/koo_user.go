...
type userService struct {
	userRepo repository.KooUserRepository
	petRepo  repository.KooPetRepository
}

func NewKooUserService(userRepo repository.KooUserRepository, petRepo repository.KooPetRepository) KooUserService {
	return &userService{
		userRepo: userRepo,
		petRepo:  petRepo,
	}
